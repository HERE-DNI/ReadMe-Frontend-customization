...
(function () {
  ...
  var COLUMNS = [
    ...
    },
    {
      ...
      items: [
        ...
        {
          text: { en: "HERE WeGo", ja: "HERE WeGo" },
          href: {
            en: "/here-wego",
  ...
  function inject(doc) {
    ...
    // Only inject when ReadMe's project picker is actually present.
    if (
    ...
    // If our markup is already present, just wire up references and hide the
    // ReadMe container again (it may have re-appeared after a route change).
